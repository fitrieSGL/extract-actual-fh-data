...
readCSVAndInsertToDbTwo(
  'C:/Users/Fitrie/Desktop/etc-FHIS/extract-actual-data/src/csv/new-fh-data/PS.csv',
  'C:/Users/Fitrie/Desktop/etc-FHIS/extract-actual-data/src/csv/error/PS.csv'
);
